...
public class Validator {
    public enCapsulatedValidatedResult validate(StudentDTO sdto){
         ...
         //skills
         Set<String> normalizedSkillsSet = new HashSet<>();
         ...
         try {
             ...
             for(String skill:skills){
                 if(!skill.trim().isEmpty()&&normalizedSkillsSet.add(skill.trim().toLowerCase())){
         ...
         if(invalidReasons.isEmpty()){
             ValidatedStudentDTO vsdto = new ValidatedStudentDTO(branch, cgpa, gradYear, activeBacklogs, normalizedSkills, normalizedSkillsSet);
